import re
from inputUS.models import UserStory_element, UserStory_What, UserStory_Who, UserStory_Why, US_Upload
...
def segmentation(obj_id):
    ...
    for item in UserStories:
        ...
        if m_action:
            ...
            pattern = r'\b(?:' + '|'.join(re.escape(phrase) for phrase in goal_phrases) + r')\b'
            ...
            if find_goal:
                ...
                if len(action_occurrences) > 1:
                    ...
                    split_action = re.split(re.escape(goal_id), action_usr, flags=re.IGNORECASE)
