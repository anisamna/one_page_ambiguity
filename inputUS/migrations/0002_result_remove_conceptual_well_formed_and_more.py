...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='result',
            name='UserStory_Segment_ID',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='inputUS.userstory_element'),
        ),
        migrations.AlterField(
            model_name='similarity_analysis',
            name='Well_Formed_1',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='well_formed_a_set', to='inputUS.result'),
        ),
        migrations.AlterField(
            model_name='similarity_analysis',
            name='Well_Formed_2',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='well_formed_b_set', to='inputUS.result'),
        ),
        migrations.AlterField(
            model_name='wordnet_classification',
            name='well_formed',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='inputUS.result'),
        ),
        migrations.DeleteModel(
            name='Well_Formed',
        ),
